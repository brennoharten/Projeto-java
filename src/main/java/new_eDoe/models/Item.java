...
//	private int pontuacaoMatch = 0;
     ...
     *
     */
    public Item(String descricao, int quantidade, boolean ehNecessario, int id, String dadosEmissor) {
        this.id = id;
...
//	}
     ...
     */
    @Override
    public String toString() { return this.id + " - " + this.descricao  + ", quantidade: " + this.quantidade;
    }

...
public abstract class Usuario implements Usuario_eDoe, Serializable {
     ...
     */
    public int adicionaItemParaDoacao(String descricao, int quantidade, boolean ehNecessario, int idItem) {
        Item i = new Item(descricao, quantidade, ehNecessario, idItem,
     ...
     */
    public String atualizaItem(int idItem, int novaQuantidade) {
...
//			i.setTags(novasTags);
     ...
     */
    public int adicionaItemNecessario(String descricao, int quantidade, boolean ehNecessario, int idItem) {
        Item i = new Item(descricao, quantidade, ehNecessario, idItem,

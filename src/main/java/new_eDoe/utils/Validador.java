...
public class Validador {
     ...
     *
     * @param idUser   Documento de identificação do Usuario
     ...
     */
    public static void validadorAdicionaUsuario(String idUser, String nome, String email, String celular, String classe,

...
import new_eDoe.models.Receptor;
...
public class CrudUsuario implements Serializable {
     ...
     *
     * @param idUsuario Documento de identificação do Usuario
     ...
     */
    public String adicionarUsuario(String idUsuario, String nome, String email, String celular, String classe, String status) {
        Validador.validadorAdicionaUsuario(idUsuario, nome, email, celular, classe, this.usuarios);
        if (status == "doador") {
            this.usuarios.put(idUsuario, new Doador(idUsuario, nome, email, celular, classe, status));
        }
        else if (status == "receptor") {
            this.usuarios.put(idUsuario, new Receptor(idUsuario, nome, email, celular, classe, status));
        } else {
            throw new IllegalArgumentException("status não definido");
        }
        return idUsuario;
    }
     ...
     *
     * @param descricao Descritor geral dos itens
     */
     ...
     */
    public int adicionaItemParaDoacao(String idDoador, String descricao, int quantidade, int idItem) {
        Usuario u = getUsuarioValido(idDoador, "doador");
        return this.g.adicionaItemParaDoacao(u, descricao, quantidade, idItem);
    }
     ...
     */
    public String atualizaItemParaDoacao(int idItem, String idDoador, int novaQuantidade) {
        Usuario u = getUsuarioValido(idDoador, "doador");
        return this.g.atualizaItemParaDoacao(u, idItem, novaQuantidade);
    }
